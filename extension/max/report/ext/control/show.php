...
class myReport extends report
{
    ...
    public function show($reportID, $reportModule = '')
    {
        ...
        else
        {
            ...
            $reportModuleMenu = $this->lang->report->menu->pivotTable['subMenu']->$reportModule;
            $reportModuleMenu['alias'] = 'show';
            $this->lang->report->menu->pivotTable['subMenu']->$reportModule = $reportModuleMenu;
        }
        ...
        if($this->config->edition == 'max' and $this->session->project) $this->report->buildReportList($this->session->project);
        ...
        if($reportModule == 'product' && in_array($productTable, $tables)) $sql = str_replace($productTable, 'ztv_normalproduct', $sql);
