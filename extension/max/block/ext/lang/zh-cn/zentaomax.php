...
if(helper::hasFeature('waterfall_issue')) $lang->block->modules['waterfall']['index']->availableBlocks->waterfallissue = '项目问题';
if(helper::hasFeature('waterfall_risk'))  $lang->block->modules['waterfall']['index']->availableBlocks->waterfallrisk  = '项目风险';

if(helper::hasFeature('scrum_issue')) $lang->block->modules['scrum']['index']->availableBlocks->scrumissue = '项目问题';
if(helper::hasFeature('scrum_risk'))  $lang->block->modules['scrum']['index']->availableBlocks->scrumrisk  = '项目风险';
