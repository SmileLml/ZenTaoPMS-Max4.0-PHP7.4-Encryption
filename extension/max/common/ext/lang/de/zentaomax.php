...
if(!helper::hasFeature('scrum_issue'))
{
    unset($lang->scrum->menu->other['dropMenu']->issue);
    unset($lang->execution->menu->other['dropMenu']->issue);
}
if(!helper::hasFeature('scrum_risk'))
{
    unset($lang->scrum->menu->other['dropMenu']->risk);
    unset($lang->execution->menu->other['dropMenu']->risk);
}
if(!helper::hasFeature('scrum_meeting'))
{
    unset($lang->scrum->menu->other['dropMenu']->meeting);
    unset($lang->execution->menu->other['dropMenu']->meeting);
}
if(!helper::hasFeature('scrum_measrecord'))       unset($lang->scrum->menu->other['dropMenu']->report);
if(!helper::hasFeature('scrum_opportunity'))      unset($lang->execution->menu->other['dropMenu']->opportunity);
if(!helper::hasFeature('scrum_process'))          unset($lang->execution->menu->other['dropMenu']->pssp);
if(!helper::hasFeature('scrum_auditplan'))        unset($lang->execution->menu->other['dropMenu']->auditplan);
if(!helper::hasFeature('waterfall_issue'))        unset($lang->waterfall->menu->other['dropMenu']->issue);
if(!helper::hasFeature('waterfall_risk'))         unset($lang->waterfall->menu->other['dropMenu']->risk);
if(!helper::hasFeature('waterfall_meeting'))      unset($lang->waterfall->menu->other['dropMenu']->meeting);
if(!helper::hasFeature('waterfall_measrecord'))   unset($lang->waterfall->menu->other['dropMenu']->report);
if(!helper::hasFeature('waterfall_opportunity'))  unset($lang->waterfall->menu->other['dropMenu']->opportunity);
if(!helper::hasFeature('waterfall_process'))      unset($lang->waterfall->menu->other['dropMenu']->pssp);
if(!helper::hasFeature('waterfall_auditplan'))    unset($lang->waterfall->menu->other['dropMenu']->auditplan);
if(!helper::hasFeature('waterfall_track'))        unset($lang->waterfall->menu->track);
if(!helper::hasFeature('waterfall_gapanalysis'))  unset($lang->waterfall->menu->other['dropMenu']->train);
if(!helper::hasFeature('waterfall_researchplan')) unset($lang->waterfall->menu->other['dropMenu']->research);
...
{
    unset($lang->admin->menu->scrum['subMenu']->auditcl);
...
if(!helper::hasFeature('meeting'))
{
    ...
    unset($lang->admin->menu->allModel['subMenu']->meetingroom, $lang->admin->menu->allModel['menuOrder'][25]);
}
if(!helper::hasFeature('measrecord')) unset($lang->admin->menu->allModel['subMenu']->measurement, $lang->admin->menu->allModel['menuOrder'][30]);
if(!helper::hasFeature('process'))    unset($lang->admin->menu->scrum['subMenu']->process);
