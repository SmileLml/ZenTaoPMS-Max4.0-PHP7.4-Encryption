...
class zoutput extends control
{
     ...
     * @return void
     */
    public function browse($browseType = 'all', $param = 0, $orderBy = 'order_desc', $recTotal = 0, $recPerPage = 15, $pageID = 1)
    {
        ...
        $actionURL = $this->createLink('zoutput', 'browse', "browseType=bysearch&queryID=myQueryID");
    ...
    public function create()
    {
        ...
        if($_POST)
        {
            ...
            return $this->send(array('result' => 'success', 'message' => $this->lang->saveSuccess, 'locate' => inLink('browse', 'browseType=all')));
        }
    ...
    public function edit($outputID)
    {
        ...
        if($_POST)
        {
            ...
            $locate = isonlybody() ? $this->createLink('activity', 'outputList', "activityID=$zoutput->activity") : inLink('browse', 'browseType=all');
