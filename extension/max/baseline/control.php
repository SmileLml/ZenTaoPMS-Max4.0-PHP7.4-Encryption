...
class baseline extends control
{
     ...
     * @return void
     */
    public function articleview($baselineID = 0)
    {
        $this->view->doc = $this->baseline->getByID($baselineID);
        $this->display();
    }
     ...
     * @return void
     */
    public function catalog($currentModuleID = 0)
    {
        $this->view->title           = $this->lang->baseline->catalog;
        $this->view->position        = $this->lang->baseline->catalog;
        $this->view->modules         = $this->loadModel('tree')->getTreeMenu(0, 'doc', 0, array('treeModel', 'createManageLink'));
        $this->view->sons            = $this->tree->getSons(0, $currentModuleID, 'doc');
        $this->view->currentModuleID = $currentModuleID;
        $this->view->tree            = $this->tree->getProductStructure(0, 'doc');
