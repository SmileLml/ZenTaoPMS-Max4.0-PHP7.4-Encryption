...
class myProjectstory extends projectstory
{
     ...
     * @return void
     */
    public function importFromLib($projectID, $productID, $libID = 0, $orderBy = 'id_desc', $browseType = 'all', $queryID = 0, $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        ...
        $actionURL = $this->createLink('projectstory', 'importFromLib', "projectID=$projectID&productID=$productID&libID=$libID&orderBy=$orderBy&browseType=bysearch&queryID=myQueryID");
