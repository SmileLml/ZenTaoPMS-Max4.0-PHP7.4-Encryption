...
class auditcl extends control
{
    ...
    public function browse($processID = 0, $browseType = 'all', $param = '', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 50, $pageID = 1)
    {
        ...
        $actionURL = $this->createLink('auditcl', 'browse', "processID=$processID&browseType=bysearch&queryID=myQueryID");
     ...
     * @return void
     */
    public function scrumBrowse($processID = 0, $browseType = 'all', $param = '', $orderBy = 'id_desc', $recTotal = 0, $recPerPage = 50, $pageID = 1)
    {
