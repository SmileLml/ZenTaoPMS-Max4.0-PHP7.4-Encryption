      ...
      <tbody>
        ...
        <tr class='text-left'>
          ...
          <td class='c-actions'>
            ...
            if(common::hasPriv('host', 'changeStatus', $host)) echo html::a($this->inlink('changeStatus', "id=$host->id&id=$host->id&status=$host->status", 'html', true), $icon, '', "class='btn iframe' title='{$title}'");
