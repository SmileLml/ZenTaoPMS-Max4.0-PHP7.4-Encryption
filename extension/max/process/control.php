...
class process extends control
{
    ...
    public function browse($browseType = 'all', $param = 0, $orderBy = 'order_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        ...
        $this->loadModel('auditcl')->setMenu($browseType);
        $this->session->set('model', $browseType);
        ...
        $actionURL = $this->createLink('process', 'browse', "browseType=bysearch&queryID=myQueryID");
     ...
     * @return void
     */
    public function scrumBrowse($browseType = 'all', $param = 0, $orderBy = 'order_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
