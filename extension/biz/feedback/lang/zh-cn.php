...
$lang->feedback->productModule  = '产品模块';
$lang->feedback->syncProduct    = '同步产品模块';
$lang->feedback->syncProductTo  = '同步产品的';
$lang->feedback->syncConfirm    = '产品模块同步成功，是否将历史模块与产品模块进行合并，合并后不能恢复。';
$lang->feedback->syncWarning    = '产品模块同步后，无法进行撤销和修改操作。';

$lang->feedback->productSetting          = '产品设置';
$lang->feedback->head                    = '反馈负责人';
$lang->feedback->ticketHead              = '工单负责人';
$lang->feedback->productSettingSaveError = '产品设置需要至少保留一个产品，反馈功能才能正常使用。';
...
$lang->feedback->noProject     = '还没有选择' . $lang->project->common . '！';
$lang->feedback->noExecution   = '还没有选择' . $lang->execution->common . '！';
...
$lang->feedback->productSettingNoProduct = '暂时无产品可设置';
