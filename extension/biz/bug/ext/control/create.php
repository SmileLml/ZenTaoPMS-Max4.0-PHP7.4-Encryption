...
class myBug extends bug
{
    public function create($productID, $branch = '', $extras = '')
    {
        ...
        if(!empty($fromType))
        {
            ...
            if($executionID)
            {
                $builds  = $this->loadModel('build')->getBuildPairs($productID, $branch, 'noempty,noterminate,nodone,noreleased', $executionID);
            ...
            {
                $builds  = $this->loadModel('build')->getBuildPairs($productID, $branch, 'noempty,noterminate,nodone,noreleased');
