...
class flow extends control
{
    ...
    public function ajaxGetNodes($object = '')
    {
        ...
        $noLetterUsers = $this->user->getDeptPairs('noletter|nodeleted|noclosed');
        ...
        {
            $html .= '<tr>';
            $html .= "<td class='text-center'>" . $node['title'] . (isset($node['appointees']) ? '' : html::hidden('approval_id[]', $node['id'])) . '</td>';
            $html .= '<td>';
            ...
            {
                $html .= in_array('reviewer', $node['types']) ? html::select('approval_reviewer[' . $node['id'] . '][]', $users, '', "multiple class='form-control chosen'") : html::hidden('approval_reviewer[' . $node['id'] . '][]', '');
            }
            ...
            {
                $html .= in_array('ccer', $node['types']) ? html::select('approval_ccer[' . $node['id'] . '][]', $users, '', "multiple class='form-control chosen'") : html::hidden('approval_ccer[' . $node['id'] . '][]', '');
            }
