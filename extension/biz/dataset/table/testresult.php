...
$schema->objects['build']['id']   = array('type' => 'number', 'name' => $this->lang->dataset->id);
...
$schema->objects['casemodule']['id']   = array('type' => 'number', 'name' => $this->lang->dataset->id);
$schema->objects['casemodule']['name'] = array('type' => 'string', 'name' => $this->lang->dataset->name);

$schema->objects['caselib'] = array();
$schema->objects['caselib']['id']   = array('type' => 'number', 'name' => $this->lang->dataset->id);
