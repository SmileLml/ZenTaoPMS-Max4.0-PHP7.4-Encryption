...
$lang->block->flowchart['project'] = array('項目經理', '創建項目、' . $lang->execution->common, '維護團隊', "關聯需求", '分解任務', '跟蹤進度');
...
$lang->block->zentaoapp->desc                 = '禪道移動端為您提供移動辦公的環境，方便隨時管理個人待辦事務，跟進項目進度，增強了項目管理的靈活性和敏捷性。';
...
$lang->block->visions['rnd']->text   = '集項目集、產品、項目、執行、測試等多維度管理於一體，提供全過程項目管理解決方案。';
$lang->block->visions['lite']        = new stdclass();
$lang->block->visions['lite']->key   = 'lite';
$lang->block->visions['lite']->title = '運營管理界面';
$lang->block->visions['lite']->text  = '專為非研發團隊打造，主要以直觀、可視化的看板項目管理模型為主。';
...
$lang->block->customModeTip->light  = '適用於小型研發團隊的管理模式，提供項目管理的核心功能。';
