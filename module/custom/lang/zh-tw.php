...
$lang->custom->selectProgramTips = '切換到輕量管理模式後，為確保資料結構一致，需要選擇一個項目集作為預設項目集，後續新增的產品和項目數據都關聯在這個預設的項目集下。';

$lang->custom->modeList['light'] = '輕量級管理模式';
$lang->custom->modeList['ALM']   = '全生命周期管理模式';

$lang->custom->modeIntroductionList['light'] = '提供了項目管理的核心功能，適用於小型研發團隊';
$lang->custom->modeIntroductionList['ALM']   = '概念更加完整、嚴謹，功能更加豐富，適用於中大型研發團隊';

$lang->custom->features['program']          = '項目集';
$lang->custom->features['productRR']        = '產品-研發需求';
$lang->custom->features['productUR']        = '產品-用戶需求';
$lang->custom->features['productLine']      = '產品-產品綫';
$lang->custom->features['projectScrum']     = '項目-敏捷模型';
$lang->custom->features['projectWaterfall'] = '項目-瀑布模型';
$lang->custom->features['projectKanban']    = '項目-看板模型';
...
$lang->custom->features['report']           = '統計';
...
$lang->custom->needClosedFunctions['waterfall'] = '瀑布項目';
