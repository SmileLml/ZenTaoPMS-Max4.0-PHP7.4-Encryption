...
$lang->story->syncTip             = "孿生需求間除產品、分支 、模組、計劃、階段外均同步，孿生關係解除後不再同步";
...
$lang->story->relievedTwinsTip    = '產品調整後，本需求自動解除孿生關係，需求不再同步，是否保存？';
...
$lang->story->notice->branch = '每個分支會建立一個需求，需求間互為孿生關係。孿生需求間除產品、分支、模組、計劃、階段欄位外均保持同步，後期您可以手動解除孿生關係。';
