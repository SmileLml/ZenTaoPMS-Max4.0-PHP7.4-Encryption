...
$lang->action->desc->syncmultipleproject  = '$date, 系統判斷由於任務開始，將項目狀態置為進行中。' . "\n";
...
$lang->action->desc->switchtolight        = '$date, 由於 <strong>'. $lang->admin->system .'</strong> 從全生命周期管理模式切換為輕量管理模式，項目訪問控制由項目集內公開調整為私有。' . "\n";
$lang->action->desc->getvnc               = '$date, <strong>$actor</strong>對執行節點 <strong>$extra</strong> 進行了遠程操控。' . "\n";
$lang->action->desc->unlinkproduct        = '$date, 系統判斷由於' . $lang->executionCommon . '所屬項目與$extra取消關聯，同步將' . $lang->executionCommon . '與$extra取消關聯。' . "\n";
...
$lang->action->label->linked2project        = "關聯了項目";
$lang->action->label->unlinkedfromproject   = "移除了項目";
...
$lang->action->label->unlinkedrepo          = '取消了項目與代碼庫的關聯';
$lang->action->label->unlinkproduct         = '取消了與產品的關聯';
...
$lang->action->desc->unlinkedrepo                 = '$date, 由 <strong>$actor</strong> 取消了項目與代碼庫 $extra 的關聯';
