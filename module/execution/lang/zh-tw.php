...
$lang->execution->projectNoStories     = "看起來沒有{$lang->SRCommon}可以關聯。請檢查下項目中有沒有{$lang->SRCommon}，而且要確保它們已經審核通過。";
...
$lang->execution->workloadTotal        = "工作量占比累計不應當超過100%s, 當前產品下的工作量之和為%s";
...
$lang->execution->linkBranchStoryByPlanTips = "執行按計劃關聯需求時，只導入本執行所關聯%s的激活狀態的需求。";
$lang->execution->linkNormalStoryByPlanTips = "執行按計劃關聯需求時，只導入激活狀態的需求。";